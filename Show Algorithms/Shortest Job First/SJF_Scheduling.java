 ...
 * The SJF scheduling algorithm is a non-preemptive algorithm where the process with the shortest burst time is executed first.
 * It aims to minimize the average waiting time of processes.
 **/
